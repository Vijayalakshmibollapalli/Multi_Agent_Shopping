...
def search_products(query:str):
    """Find real product models, features and specifications."""
...
def search_prices(query:str):
    """Find current prices and availability from retailers and official stores."""
...
def search_web(query:str):
    """Search recent and relevant web information."""
    return format_results(search(f"{query} latest information reviews comparison",6),4000)

@mcp.tool
def search_youtube(query:str):
    """Find YouTube product reviews and comparison videos."""
